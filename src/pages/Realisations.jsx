                            ...
                            {filters.map(filter => {
                                ...
                                return (
                                    <button
                                        ...
                                        className={`flex items-center gap-2 px-5 py-2 rounded-full text-sm font-semibold border transition-all shadow-sm ${activeFilter === filter.key
                                            ? 'bg-dark text-white border-transparent shadow-md'
                                            : 'bg-white text-ink border-border hover:border-secondary/50'
                                            }`}
                                    >
                    ...
                    <div className="container px-4 mx-auto lg:px-8">
                            ...
                            <motion.div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3" layout>
                                {visibleProjectsList.map(project => {
                                    return (
                                        ...
                                        >
                                            <div
                                                className="absolute inset-x-0 top-0 h-1 bg-gradient-to-r from-secondary via-primary to-primary/60"
                                                aria-hidden="true"
                                            />
                                            ...
                                            <div className="relative z-10 p-6">
                                                <span className="inline-flex px-3 py-1 mb-3 text-xs font-semibold tracking-wide uppercase rounded-[var(--radius-sm)] bg-surface-warm border border-border text-ink-muted">
                                                ...
                                                <div className="flex items-center mt-4 text-xs text-ink-muted">
                        ...
                        {visibleProjects < filteredProjects.length && (
                            <motion.div
                                ...
                                viewport={{ once: true }}
                            >
                                <button onClick={loadMoreProjects} className="btn-primary">
                            ...
                            {testimonials.map((testimonial, index) => (
                                ...
                                >
                                    <div className="flex items-center mb-4">
                                        <div className="flex items-center justify-center w-10 h-10 rounded-full bg-surface-warm mr-3">
                                            <ThumbsUp className="text-secondary" size={18} />
                                        </div>
                                        <div>
                        ...
                        <div className="max-w-4xl mx-auto">
                            {processSteps.map((step, index) => (
                                <motion.div
                                    ...
                                    viewport={{ once: true }}
                                >
                                    <div className="flex-shrink-0 w-14 h-14 mr-6 text-base font-bold text-ink border rounded-full border-border flex items-center justify-center bg-surface-warm">
                            ...
                            {industries.map((industry, index) => {
                                ...
                                return (
                                    <motion.div
                                        ...
                                        variants={itemVariants}
                                    >
                                        <div className="flex items-center justify-center w-12 h-12 mx-auto mb-4 rounded-full bg-surface-warm">
