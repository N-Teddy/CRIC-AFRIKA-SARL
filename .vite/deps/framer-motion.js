import { __commonJS, __export, __toESM, require_react } from './chunk-SBWQ5KBM.js'
      ...
      function jsxDEVImpl(type, config, maybeKey, isStaticChildren, debugStack, debugTask) {
        ...
        if (hasOwnProperty.call(config, 'key')) {
          ...
          didWarnAboutKeySpread[children + isStaticChildren] ||
            ((keys2 = 0 < keys2.length ? '{' + keys2.join(': ..., ') + ': ...}' : '{}'),
            console.error(
        ...
        if (dampingRatio < 1) {
          currentVelocity =
            t === 0
              ...
              : calcGeneratorVelocity(resolveSpring, t, current2)
        }
...
var attrEffect = createSelectorEffect(createEffect(addAttrValue))
    ...
    if (!state.get('stroke-dasharray')) {
      state.set('stroke-dasharray', new MotionValue('1 1'), () => {
        ...
        element.setAttribute(
          'stroke-dasharray',
          `${toPx(pathLength)} ${toPx(pathSpacing ?? 1 - Number(pathLength))}`
        )
      })
    }
...
var svgEffect = createSelectorEffect(createEffect(addSVGValue))
        ...
        for (const key of definitionNames) {
          ...
          for (let [valueName, valueKeyframes] of Object.entries(keyframes2)) {
            ...
            valueOptions.duration &&
              (valueOptions.duration = secondsToMilliseconds(valueOptions.duration))
...
function PopChild({ children, isPresent: isPresent2, anchorX, root }) {
  ...
  return (0, import_jsx_runtime.jsx)(PopChildMeasure, {
    ...
    childRef: ref,
    sizeRef: size,
    children: React2.cloneElement(children, { ref: composedRef })
  })
}
...
function usePresence(subscribe = true) {
  ...
  const safeToRemove = (0, import_react8.useCallback)(
...
function onlyElements(children) {
  ...
  import_react9.Children.forEach(children, child => {
    if ((0, import_react9.isValidElement)(child)) filtered.push(child)
  })
  return filtered
}
...
function useRender(Component3, props, ref, { latestValues }, isStatic, forwardMotionProps = false) {
  ...
  const elementProps =
    Component3 !== import_react22.Fragment ? { ...filteredProps, ...visualProps, ref } : {}
  const { children } = props
  const renderedChildren = (0, import_react22.useMemo)(
...
// node_modules/.pnpm/framer-motion@12.23.24_react-dom@19.2.0_react@19.2.0__react@19.2.0/node_modules/framer-motion/dist/es/motion/utils/use-visual-state.mjs
function makeState(
  { scrapeMotionValuesFromProps: scrapeMotionValuesFromProps3, createRenderState },
  props,
  context,
  presenceContext
) {
...
function useVisualElement(
  ...
  const wantsHandoff = (0, import_react26.useRef)(
...
function updateMotionValuesFromProps(element, next2, prev) {
  ...
  for (const key in prev) {
    if (next2[key] === void 0) element.removeValue(key)
  }
  return next2
}
...
function renderSVG(element, renderState, _styleProp, projection) {
  ...
  for (const key in renderState.attrs) {
    element.setAttribute(
      !camelCaseAttributes.has(key) ? camelToDash2(key) : key,
...
var MeasureLayoutWithContext = class extends import_react29.Component {
  ...
  getSnapshotBeforeUpdate(prevProps) {
    ...
    if (
      ...
      prevProps.isPresent !== isPresent2
    ) {
...
function MeasureLayout(props) {
  ...
  return (0, import_jsx_runtime8.jsx)(MeasureLayoutWithContext, {
    ...props,
    layoutGroup,
    switchLayoutGroup: (0, import_react29.useContext)(SwitchLayoutGroupContext),
    isPresent: isPresent2,
    safeToRemove
  })
}
  ...
  for (let i = 0; i < numBorders; i++) {
    ...
    if (canMix) {
      target[borderLabel] = Math.max(
        mixNumber(asNumber2(followRadius), asNumber2(leadRadius), progress2),
        0
      )
...
function createProjectionNode2({
  ...
  return class ProjectionNode {
    ...
    applyProjectionStyles(targetStyle, styleProp) {
      ...
      let transform2 = buildProjectionTransform(
        this.projectionDeltaWithTransform,
        this.treeScale,
        valuesToRender
      )
      ...
      for (const key in scaleCorrectors) {
        ...
        const corrected =
          transform2 === 'none' ? valuesToRender[key] : correct(valuesToRender[key], lead)
        if (applyTo) {
  ...
  for (let i = 0; i < sequence.length; i++) {
    ...
    const resolveValueSequence = (
      ...
      const calculatedDelay =
        typeof delay2 === 'function' ? delay2(elementIndex, numSubjects) : delay2
...
function ReorderGroupComponent(
  ...
  return (0, import_jsx_runtime10.jsx)(Component3, {
    ...
    ref: externalRef,
    ignoreStrict: true,
    children: (0, import_jsx_runtime10.jsx)(ReorderContext.Provider, { value: context, children })
  })
}
...
function ReorderItemComponent(
  { children, style: style2 = {}, value, as = 'li', onDrag, layout: layout2 = true, ...props },
  externalRef
) {
  const Component3 = useConstant(() => motion[as])
  ...
  return (0, import_jsx_runtime11.jsx)(Component3, {
    ...
    style: { ...style2, x: point2.x, y: point2.y, zIndex },
    layout: layout2,
